...
namespace BizUnit.TestSteps.File
{
	...
	public class FileReadMultipleStep : TestStepBase
	{
		...
		private long _numberOfBytesToLog = -1;
		///<summary>
		/// The maximum number of bytes to log the file data for
		///</summary>
		public long NumberOfCharsToLog
		{
			get { return _numberOfBytesToLog; }
			set { _numberOfBytesToLog = value; }
		}
