...
namespace BizUnit.TestSteps.Sql
{
    ...
    public class DbQueryStep : TestStepBase
    {
        ...
        public override void Execute(Context context)
        {
            ...
            DataSet ds = FillDataSet(ConnectionString, CommandTimeout, sqlQueryToExecute);
        ...
        private static DataSet FillDataSet(string connectionString, int commandTimeout, string sqlQuery)
        {
            ...
            using (connection)
            {
                ...
                if (ds.Tables.Count == 0)
                    ds.Tables.Add(new DataTable("BizUnit"));
                return ds;
            }
        }
