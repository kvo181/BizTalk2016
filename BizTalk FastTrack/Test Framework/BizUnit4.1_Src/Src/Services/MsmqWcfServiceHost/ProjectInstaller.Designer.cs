namespace MsmqWcfServiceHost
{
    partial class ProjectInstaller
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.serviceInstaller1.Description = "Wcf Service Host we use to create/delete MSMQ queues.";
            this.serviceInstaller1.DisplayName = "MsmqWcfWindowsService";
            this.serviceInstaller1.ServiceName = "MsmqWcfWindowsService";
