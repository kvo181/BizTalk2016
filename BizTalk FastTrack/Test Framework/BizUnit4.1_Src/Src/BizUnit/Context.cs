...
namespace BizUnit
{
    ...
    public class Context
    {
        ...
        ///<summary>
        /// Checks to see if a key was previously saved to the context.
        ///</summary>
        ...
        /// </summary>
        /// <param name="description">The description of what the data being logged is.</param>
        /// <param name="sr">StreamReader to read the data to log</param>
        /// <param name="numberOfChars">Maximum number of bytes to log (-1 indicates all)</param>
        public void LogData(string description, StreamReader sr, long numberOfChars)
        {
            ArgumentValidation.CheckForNullReference(description, "description");
            ArgumentValidation.CheckForNullReference(sr, "sr");
            ArgumentValidation.CheckForNullReference(numberOfChars, "numberOfBytes");

            _logger.LogData(description, sr, numberOfChars);
        }
        ...
        /// <param name="description">The description of what the data being logged is.</param>
        /// <param name="data">The stream containing the data to log.</param>
        /// <param name="numberOfChars">Max. number of bytes to log</param>
        public void LogData(string description, Stream data, long numberOfChars)
        {
            LogData(description, new StreamReader(data), numberOfChars);
        }
