...
namespace Winterdom.BizTalk.PipelineTesting
{
   ...
   /// </summary>
   internal interface IConfigurePipelineContext : IPipelineContext, IPipelineContextEx, Microsoft.Test.BizTalk.PipelineObjects.IInitializePipelineContext
   {
   ...
   public class PipelineContext : IPipelineContext, IPipelineContextEx, IConfigurePipelineContext
   {
      ...
      {
          return (this._docSpecsByName[name] != null);
      }

      public bool HasDocumentSpecByType(string type)
      {
          return (this._docSpecsByType[type] != null);
      }
