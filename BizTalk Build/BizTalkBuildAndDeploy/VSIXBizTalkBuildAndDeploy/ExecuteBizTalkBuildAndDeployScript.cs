//------------------------------------------------------------------------------
// <copyright file="ExecuteBizTalkBuildAndDeployScript.cs" company="Company">
...
namespace VSIXBizTalkBuildAndDeploy
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class ExecuteBizTalkBuildAndDeployScript
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExecuteBizTalkBuildAndDeployScript"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        private ExecuteBizTalkBuildAndDeployScript(Package package)
        {
            if (package == null)
            {
        ...
        /// </summary>
        public static ExecuteBizTalkBuildAndDeployScript Instance
        {
            get;
            private set;
        }
        ...
        private void CommandQueryStatus(object sender, EventArgs e)
        {
            ...
            _owp.OutputString(string.Format("Execute BizTalk Build and Deploy script command {0}", oCommand.Visible ? "visible" : "not visible"));
            _owp.OutputString(Environment.NewLine);
        }
        /// <summary>
        ...
        {
            // We should also check if a build script is included in the solution...
            // It makes no sense to execute without a build script
