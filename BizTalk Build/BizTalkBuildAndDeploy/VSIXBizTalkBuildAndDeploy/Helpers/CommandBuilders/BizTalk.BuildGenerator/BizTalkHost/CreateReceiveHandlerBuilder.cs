...
{
    public class CreateReceiveHandlerBuilder : ICommandBuilder
    {
        private const string Command = "\t\t<BizTalk.BuildGenerator.Tasks.CreateReceiveHandler  HostName=\"{0}\" AdapterName=\"{1}\" />";
        private const string Key = "<!-- @CreateReceiveHandlerCommand@ -->";
