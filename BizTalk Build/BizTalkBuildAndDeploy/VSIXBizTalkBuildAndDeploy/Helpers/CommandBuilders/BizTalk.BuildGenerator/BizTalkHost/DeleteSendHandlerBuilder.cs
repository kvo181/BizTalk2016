...
{
    public class DeleteSendHandlerBuilder : ICommandBuilder
    {
        private const string Command = "\t\t<BizTalk.BuildGenerator.Tasks.DeleteSendHandler ContinueOnError=\"true\"   HostName=\"{0}\" AdapterName=\"{1}\" />";
        private const string Key = "<!-- @DeleteSendHandlerCommand@ -->";
